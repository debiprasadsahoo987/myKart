...
import com.mykart.project.repositories.AddressRepository;
import com.mykart.project.service.AddressService;
...
public class AddressController {
    ...
    public ResponseEntity<AddressDTO> updateAddressById(@PathVariable("addressId") Long addressId, @Valid @RequestBody AddressDTO addressDTO){
